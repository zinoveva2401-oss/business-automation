...
const tools = defineCollection({
  ...
  schema: z.object({
    ...
    managementLevels: z.array(z.string()).default([]), workbookSections: z.array(z.string()).default([]),
    previewSlots: z.array(z.object({ title: z.string(), description: z.string() })).default([]), problem: z.string(), forWhom: z.array(z.string()),
