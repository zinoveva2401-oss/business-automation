...
The former B — `Редакционный маршрут` plus A — `Рабочий стол причин` package is retained under `docs/design/site-brand-001/approved/` for historical provenance and BEFORE comparison. It is explicitly rejected as current visual authority.
