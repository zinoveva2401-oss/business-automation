...
const targets = [
  ...
  'scripts/network-throttling-probe.mjs',
  'scripts/guard-staged-media.mjs',
  'scripts/second-brain-video-exam.mjs',
  'scripts/resolve-local-capabilities.mjs',
  ...
  'tests/fixtures/second-brain/reasoning/novel-tasks.json',
  'tests/fixtures/second-brain/performance/network-evidence.json',
  'tests/fixtures/second-brain/visual/evidence/network-throttled.png',
  'tests/fixtures/second-brain/video/evidence/video-evidence.json',
  'tests/fixtures/second-brain/security/npm-audit-high.json',
